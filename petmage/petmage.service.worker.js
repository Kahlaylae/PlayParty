...
/** @type {string} */
const CACHE_VERSION = '1776074653|2719528591';
/** @type {string} */
const CACHE_PREFIX = 'bluigi-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'petmage.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["petmage.html","petmage.js","petmage.offline.html","petmage.icon.png","petmage.apple-touch-icon.png","petmage.audio.worklet.js","petmage.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["petmage.wasm","petmage.pck"];
